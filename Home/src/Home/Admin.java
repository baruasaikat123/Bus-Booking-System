	...
	void admin_fun()throws Exception{
		...
		while(true) {
			...
			switch(choice) {
			     ...
			     case 9: out.println("******** All Seat Number Details *********");
                         query = "SELECT * FROM seat_detail";
                         r1 = st.executeQuery(query);
                         out.println("*******************************************************");
                         out.println("Bus No                   Seat No");
                         out.println("*******************************************************");
                         while(r1.next()) {
                        	 
                        	 out.println(r1.getInt(1)+"                         "+r1.getInt(2));
                         }
                         out.println("*******************************************************");
                         break;
                         
			     case 10: out.println("Message: Successfully Logged out!!!");
			    	     Main.logout();
